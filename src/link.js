function runDispenser() {
    ...
    switch (Number(choice)) {
      ...
      case 2:
        ...
        console.log(
          "Chocolates removed: " + removeChocolates(chocolates, number)
        );
        break;
      case 3:
        var number = prompt("Enter number");
        console.log(
          "Chocolates dispensed: " + dispenseChocolates(chocolates, number)
        );
        break;
      case 4:
        var color = prompt("Enter color");
      ...
      case 7:
        ...
        let returnVal = changeChocolateColor(
          chocolates,
          count,
          currentColor,
          finalColor
        );
        if (typeof returnVal === "string") console.log(returnVal);
        else chocolates = returnVal;
        break;
      case 8:
        var currentColor = prompt("Current color");
        var finalColor = prompt("Desired color");
        let returnArr = changeChocolateColorAllOfxCount(
          chocolates,
          currentColor,
          finalColor
        );
        if (typeof returnArr === "string") console.log(returnArr);
        else {
      ...
      case 9:
        ...
        console.log(
          "Chocolate removed: " + removeChocolateOfColor(chocolates, color)
        );
        break;
      case 10:
        var number = prompt("Chocolates to dispense");
        console.log(
          "Rainbow chocolates dispensed: " +
            dispenseRainbowChocolates(chocolates, number)
        );
        break;
    }
    console.log(chocolates);
